...
/*
 * This file is copied from the JShrink package.
 *
...
class JShrink extends Plugin {
	
	public static function minifie($sJs) {
		return JShrinkMinifier::minify($sJs);
	}
