...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', '{[getAnalytics()]}']);
_gaq.push(['_setDomainName', '{[getHost()]}']);
...
{{region begin nav}}
<a href="http://www.facebook.com/flandersisafestival/"><img src="/theme/toevla/facebook.png" id="facebook" /></a><a href="/"><img src="/theme/toevla/logo.png" id="logo" /></a><a href="/privacy" class="nav">Privacy Statement</a><a href="/tos" class="nav">Terms of service</a><a href="/about" class="nav">About</a><a href="/" class="nav">Play</a>
{{region end}}
