...
<div style="position:relative; height:100%; text-align:center;"><div tpl:content=""></div>
	...
	<div id="bg_blur">
		<div style="width:842px; margin:auto;">
			...
			<table class="zoomed" width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td class="center" size-ref="top" size-min="42" colspan="3" rowspan="3"><div id="top">
							<div id="btn_archive"><a href="/test"><img src="/theme/portfolio/btn_archive.png" onMouseOver="this.src='<[LAF]>/btn_archive_over.png';" onMouseOut="this.src='<[LAF]>/btn_archive.png';" /></a></div>
							<div id="btn_contact"><a href=""><img src="/theme/portfolio/btn_contact.png" onMouseOver="this.src='<[LAF]>/btn_contact_over.png';" onMouseOut="this.src='<[LAF]>/btn_contact.png';" /></a></div>
							<div id="btn_profile"><a href=""><img src="/theme/portfolio/btn_profile.png" onMouseOver="this.src='<[LAF]>/btn_profile_over.png';" onMouseOut="this.src='<[LAF]>/btn_profile.png';" /></a></div>
							<div id="btn_search"><a href=""><img src="/theme/portfolio/btn_search.png" onMouseOver="this.src='<[LAF]>/btn_search_over.png';" onMouseOut="this.src='<[LAF]>/btn_search.png';" /></a></div>
						</div></td>
					<td class="rrt"></td>
				</tr>
				<tr>
			...
			<div style="width:842px; height:264px;"><img src="/theme/portfolio/header.png" /></div>
			<table class="zoomed" width="100%" cellpadding="0" cellspacing="0">
				<tr>
							...
							<table class="main" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td class="r"><div class="menuItem">
											<div class="menuItemHeader"><img src="/theme/portfolio/menu_hotlinks.png" /></div>
										...
										<div class="menuItem">
											<div class="menuItemHeader"><img src="/theme/portfolio/menu_newest.png" /></div>
											<div class="menuItemContent">bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla</div>
										</div>
										<div class="menuItem">
											<div class="menuItemHeader"><img src="/theme/portfolio/menu_categories.png" /></div>
											<div class="menuItemContent">bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla</div>
										</div>
										<div class="menuItem">
											<div class="menuItemHeader"><img src="/theme/portfolio/menu_connect.png" /></div>
