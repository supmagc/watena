...
<body>
	...
	<div id="main">
		<div id="main-left">
			<div id="main-tabs">
				<div class="title" id="tabs-title">Dashboard</div>
				<ul id="tabs-list">
					<li class="tabs-item">Home</li>
					<li class="tabs-item">News</li>
					<li class="tabs-item">Session</li>
				</ul>
			</div>
			<div id="main-module">
				<div class="title">Module-Info</div>
				<u>Name</u>: <span id="module-name">AdminMain</span><br />
				<u>Version</u>: <span id="module-version">0.1.0 beta</span><br />
				<br />
				<span id="module-description">This module provides some basic welcome page functionality and is meant to be the default module when first visiting the backend.</span>
			</div>
			<div id="main-copy">2013 &copy; Voet Jelle</div>
		</div>
		<div id="main-right">
			<div id="main-content">
				<div class="title" id="content-title">Home</div>
