...
INSERT INTO `user_connection` VALUES (4,8,'ProviderFacebook',665815124,'{\"id\":\"665815124\",\"name\":\"Jelle Voet\",\"first_name\":\"Jelle\",\"last_name\":\"Voet\",\"link\":\"http:\\/\\/www.facebook.com\\/supmagc\",\"username\":\"supmagc\",\"work\":[{\"employer\":{\"id\":\"114430135239493\",\"name\":\"grin bvba\"},\"location\":{\"id\":\"103324119709358\",\"name\":\"Borgerhout, Antwerpen, Belgium\"},\"position\":{\"id\":\"104994716207822\",\"name\":\"codemaster\"},\"start_date\":\"2010-09\"}],\"education\":[{\"school\":{\"id\":\"108000932566747\",\"name\":\"Instituut Heilig Hart van Maria\"},\"type\":\"High School\"},{\"school\":{\"id\":\"114745528540826\",\"name\":\"K. U. Leuven\"},\"concentration\":[{\"id\":\"113952188615234\",\"name\":\"Informatica\"}],\"type\":\"College\"},{\"school\":{\"id\":\"106517736050851\",\"name\":\"Hogeschool West-Vlaanderen\"},\"year\":{\"id\":\"142963519060927\",\"name\":\"2010\"},\"concentration\":[{\"id\":\"154953267891988\",\"name\":\"Digital Arts and Entertainment\"},{\"id\":\"261692523885599\",\"name\":\"Multimedia en Communicatie Technologie\"}],\"type\":\"College\"}],\"gender\":\"male\",\"email\":\"supmagc@gmail.com\",\"timezone\":2,\"locale\":\"nl_NL\",\"verified\":true,\"updated_time\":\"2012-04-06T08:11:19+0000\"}','\"AAABuTmZApA3oBAEF0q8ebSqPW1VNx1X6wVFX6JKZBxylXa5VRxNLsAAm3YqsB2qjPD3MzUtWXZCxZCo2GxvdbECyXnRoiCQTe7K7Fv2wcwZDZD\"','2012-04-10 08:41:56');
...
INSERT INTO `game_character` VALUES (1,8,'supmagc','','2012-04-10 09:44:41');
...
CREATE TABLE `game_session` (
  ...
  CONSTRAINT `game_session.characterId__game_character.ID` FOREIGN KEY (`characterId`) REFERENCES `game_character` (`ID`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `game_session.userId__user.ID` FOREIGN KEY (`userId`) REFERENCES `user` (`ID`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `game_session` VALUES ('337d47d36d492a50d6046fa118384c7d',8,1,NULL,'CURRENT_TIMESTAMP');
...
INSERT INTO `user` VALUES (8,1,0,'supmagc','2','nl_NL',NULL,NULL,NULL,'2012-04-10 08:41:56');
...
INSERT INTO `user_email` VALUES (3,8,'supmagc@gmail.com',1,'a35cb84b69fedcdade8f885b4196c216','2012-04-10 08:41:56');
...
-- Dump completed on 2012-04-10 18:41:14
...
-- Dump completed on 2012-04-10 18:41:15
